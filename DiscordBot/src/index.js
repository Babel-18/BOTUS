...
const {Client, Events, IntentsBitField, User, Message, messageLink} = require('discord.js');
...
const bresidents = ["George Washington",
    "John Adams",
    "Thomas Jefferson",
    "James Madison",
    "James Monroe",
